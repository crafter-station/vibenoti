        ...
        <section className="py-20">
            <div className="relative z-10 mx-auto w-full max-w-2xl px-6 lg:px-0">
                <div className="relative">
                    <MistKitLogo />
                    <h1 className="mt-16 max-w-xl text-balance text-5xl font-medium">Get notified when your AI agents finish.</h1>

                    <p className="text-muted-foreground mb-6 mt-4 text-balance text-xl">Connect your AI coding tools to VibeNoti and route task completions, errors, and status updates to the channels you already use.</p>

                    <div className="flex flex-col items-center gap-2 *:w-full sm:flex-row sm:*:w-auto">
                        <Button  render={<Link href="#link" />} nativeButton={false}><span className="text-nowrap">Start for free</span></Button>
                        <Button variant="ghost" render={<Link href="#link" />} nativeButton={false}><span className="text-nowrap">See how it works</span></Button>
                    </div>
                </div>
